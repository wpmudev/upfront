...
require_once('compat/class_upfront_compat_sitecategories.php');
...
class Upfront_Compat implements IUpfront_Server {
	...
	private function enable_sc_compat() {
		if (class_exists('Upfront_Compat_SiteCategories')) {
			new Upfront_Compat_SiteCategories();
		}
	}
}
