	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'content' => array(
				...
				'template_nag' => __('Your current layout has changes that are not saved in the <span class="template_name">Default Template</span>. Clicking <strong>Update Template</strong> will apply those changes to <span class="template_name">Default Template</span> (for future posts only).', 'upfront'),
