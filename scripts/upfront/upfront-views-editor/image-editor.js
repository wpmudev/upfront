	 ...
	 * }
		...
		var ImageEditor = Backbone.View.extend({
			...
			open: function(options){
				breakpointColumnPadding = Upfront.Views.breakpoints_storage.get_breakpoints().get_active().get('column_padding');
