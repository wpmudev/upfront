(function ($) {
	...
	"scripts/upfront/preset-settings/preset-saver",
		"upfront/post-editor/upfront-post-edit", // If adding more arguments adjust _.rest in line 74
		...
		'spectrum'
	], function (chosen, globalEventHandlers, InlinePanelsLoader, ElementSettingsSidebar, LinkPanel, PresetSaver, PostEditorBox) {
		var _template_files = [
			"text!upfront/templates/property.html",
			"text!upfront/templates/properties.html",
			"text!upfront/templates/property_edit.html",
