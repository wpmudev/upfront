...
define(function() {
	...
	var l10n = Upfront.Settings.l10n.navigation_element;
	...
	var NavigationView = Upfront.Views.ObjectView.extend({
		...
		toolTip : _.template('<div class="nav_tooltip upfront-ui" style="display: none;"><a class="edit_url" href="#"><i class="upfront-field-icon upfront-field-icon-navigation-link"></i>' + l10n.edit_url + '</a><a class="visit_page" href="#"><i class="upfront-field-icon upfront-field-icon-navigation-open"></i>' + l10n.visit_page + '</a></div>'),
		initialize:function(){
		...
		update_auto_add_pages: function(){
			...
			Upfront.Util.post({"action": "upfront_update_auto_add_pages", "nav_menu_option": JSON.stringify(Upfront.data.navigation.auto_add)})
				.error(function(res){
					Upfront.Util.log(l10n.cant_update_auto);
				});
		},
			...
			var object = new NavigationModel({
				...
				module = new Upfront.Models.Module({
					...
					"properties": [
						...
						{"name": "class", "value": "c24 upfront-navigation_module"},
	...
	var NavigationSettings = Upfront.Views.Editor.Settings.Settings.extend({
		...
		initialize: function (opts) {
			...
			this.panels = _([
				...
				new Menu_Panel({
					model: this.model,
					label: l10n.opts.menu_label,
					title: l10n.opts.menu_title,
					settings: [
						new Upfront.Views.Editor.Settings.Item({
							model: this.model,
							title: l10n.opts.select_menu,
							fields: [
						...
						new Upfront.Views.Editor.Settings.Item({
							model: this.model,
							title: l10n.opts.create_menu,
							fields: [
								new Text_Field({
									model: this.model,
									property: 'create_menu',
									label: l10n.opts.new_menu,
									compact: true
								})
							]
						})
				...
				new Upfront.Views.Editor.Settings.Panel({
					...
					settings: [
						new Upfront.Views.Editor.Settings.Item({
							...
							fields: [
								new Upfront.Views.Editor.Field.Radios({
									...
									layout: "vertical",
									values: [
										{ label: l10n.opts.horizontal, value: 'horizontal', icon: 'navigation-horizontal' },
										{ label: l10n.opts.vertical, value: 'vertical', icon: 'navigation-vertical' }
									]
								})
							]
						}),
						new Upfront.Views.Editor.Settings.Item({
							model: this.model,
							title: l10n.opts.menu_alignment,
							fields: [
								new Upfront.Views.Editor.Field.Radios({
									model: this.model,
									...
									layout: "vertical",
									values: [
										{ label: l10n.opts.left, value: 'left', icon: 'navigation-left' },
										{ label: l10n.opts.center, value: 'center', icon: 'navigation-center' },
										{ label: l10n.opts.right, value: 'right', icon: 'navigation-right' }
									]
								})
							]
						}),
						new Upfront.Views.Editor.Settings.Item({
							...
							fields: [
								new Upfront.Views.Editor.Field.Checkboxes({
									...
									default_value: ['no'],
									values: [
										{ label: l10n.opts.hover_subnav, value: 'yes' }
									]
								}),
								new Upfront.Views.Editor.Field.Checkboxes({
									model: this.model,
									...
									label: "",
									values: [
										{ label: l10n.opts.add_new_pages, value: 'yes' }
									]
								}),
								new Upfront.Views.Editor.Field.Checkboxes({
									model: this.model,
									...
									label: "",
									values: [
										{ label: l10n.opts.allow_float, value: 'yes' }
									]
								})
							]
						})
				...
				new Extended_Panel({
					model: this.model,
					label: l10n.cnt.label,
					title: l10n.cnt.title,
					tabbed: true,
					settings: [
						new Upfront.Views.Editor.Settings.ItemTabbed({
							model: this.model,
							title: l10n.cnt.pages,
							settings: [
								new Upfront.Views.Editor.Settings.Item({
									className: 'upfront-nav-get-menu-items',
									model: this.model,
									title: l10n.cnt.all_pages,
									fields: [
										new Get_Items({
											model: this.model,
						...
						new Upfront.Views.Editor.Settings.ItemTabbed({
							model: this.model,
							title: l10n.cnt.categories,
							settings: [
								new Upfront.Views.Editor.Settings.Item({
									className: 'upfront-nav-get-menu-items',
									model: this.model,
									title: l10n.cnt.all_categories,
									fields: [
										new Get_Items({
											model: this.model,
						...
						new Upfront.Views.Editor.Settings.ItemTabbed({
							model: this.model,
							title: l10n.cnt.custom,
							settings: [
								new Add_Custom_Link_Item({
									model: this.model,
									title: l10n.cnt.add_custom,
									fields: [
										new Text_Field({
											model: this.model,
											property: 'custom_url',
				...
				new Extended_Menu_Order_Panel({
					model: this.model,
					label: l10n.ord.label,
					title: l10n.ord.title,
					settings: [
						new Upfront.Views.Editor.Settings.Item({
