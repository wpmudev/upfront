...
class Upfront_UmapView extends Upfront_Object{
	...
	public function get_markup(){
		...
		$to_map = array('markers', 'map_center', 'zoom', 'style', 'controls', 'map_styles', 'draggable', 'scrollwheel', 'hide_markers', 'static_map', 'use_custom_map_code');
		...
		$static = $properties['static_map'] || false;

		// Load Static or Dynamic Map script.
		if ($static) {
	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'static_map' => __('Use Static Map Image', 'upfront'),
			'static_map_info' => __('Does not use Controls or Custom Map Code. Size limit of 640x640 pixels.', 'upfront'),
