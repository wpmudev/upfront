 ...
 */
class Upfront_PostsLists_Model {
	...
	protected static function _spawn_query ($args, $data) {
		...
		if (!empty($data['sticky']) && 'prepend' === $data['sticky'] && !$has_pages) {
			...
			add_filter('posts_clauses', array('Upfront_PostsLists_Model', 'filter_force_home'), 10, 2);
		}
		...
		if (!empty($data['sticky']) && 'prepend' === $data['sticky'] && !$has_pages) {
			remove_filter('posts_clauses', array('Upfront_PostsLists_Model', 'filter_force_home'), 10, 2);
		}
 ...
 */
class Upfront_PostsLists_Model_Generic extends Upfront_PostsLists_Model {
 ...
 */
class Upfront_PostsLists_Model_Custom extends Upfront_PostsLists_Model {
	public static function spawn_query ($data) {
 ...
 */
class Upfront_PostsLists_Model_Taxonomy extends Upfront_PostsLists_Model {
	public static function spawn_query ($data) {
		$args = array();
