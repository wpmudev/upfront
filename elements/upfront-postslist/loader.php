...
class Upfront_PostsList extends Upfront_Server {
	...
	public function initialize () {
		...
		upfront_add_ajax('upfront_postslist-terms', array($this, "load_terms"));

		upfront_add_ajax('upfront_postslist-list_meta', array($this, "load_meta"));
