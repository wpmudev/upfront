...
- Fix Gallery Element images can be accidentally swapped when editing caption
- Fix Posts Element author part cuts off text
- Fix Manage Fonts button is not always active
- Fix selecting calendar in Widget Element causes fatal error
- Fix Menu Element added to post does not show on front end
- Fix Contact Form does not send emails properly
...
- Fix when added Tab and Accordion Element do not apply preset until they are activated
